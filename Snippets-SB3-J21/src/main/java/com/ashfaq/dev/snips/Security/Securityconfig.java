package com.ashfaq.dev.snips.Security;
...
@Configuration
public class Securityconfig implements WebMvcConfigurer { // no required to implements WebMvcConfigurer for below but try it our 
